...
![img](http://yuml.me/diagram/nofunky;dir:TB/class/\[SchemaDefinition]<from_schema(i)%20%3F-%20\[Definition|abstract:boolean%20%3F;mixin:boolean%20%3F;name(pk)(i):string;singular_name(i):string%20%3F;aliases(i):string%20*;mappings(i):uriorcuri%20*;description(i):string%20%3F;deprecated(i):string%20%3F;todos(i):string%20*;notes(i):string%20*;comments(i):string%20*;imported_from(i):string%20%3F;see_also(i):uri%20*],%20\[SubsetDefinition]<in_subset(i)%20*-%20\[Definition],%20\[Example]<examples(i)%20*-++\[Definition],%20\[Definition]<apply_to%20*-%20\[Definition],%20\[Definition]<mixins%20*-%20\[Definition],%20\[Definition]<is_a%20%3F-%20\[Definition],%20\[SchemaDefinition]-%20default_range%20%3F>\[Definition],%20\[Definition]^-\[SlotDefinition],%20\[Definition]^-\[ClassDefinition],%20\[Element]^-\[Definition])
## Inheritance
