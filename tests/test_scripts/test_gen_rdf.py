...
repl1: List[Tuple[str, str]] = [
    (r'\s*:generation_date\s*".*"\^\^xsd:dateTime', '\t:generation_date "2019-01-25 12:34"^^xsd:dateTime'),
    (r'\s*:source_file_date\s*".*"\^\^xsd:dateTime', '\t:source_file_date "2019-01-25 12:34"^^xsd:dateTime'),
]
