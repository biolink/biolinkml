...
![img](http://yuml.me/diagram/nofunky;dir:TB/class/\[OrganismTaxon]<in%20taxon(i)%200..*-%20\[Carbohydrate|id(i):identifier_type;name(i):label_type%20%3F;category(i):iri_type%20*],%20\[ChemicalSubstance]^-\[Carbohydrate])
