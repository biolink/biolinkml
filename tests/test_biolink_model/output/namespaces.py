...
class BiolinkNameSpace:
    ...
    _namespaces = [
        ...
        CurieNamespace('GTEx', 'http://example.org/UNKNOWN/GTEx/'),
        ...
        CurieNamespace('PHAROS', 'http://example.org/UNKNOWN/PHAROS/'),
        ...
        CurieNamespace('UBERON_CORE', 'http://example.org/UNKNOWN/UBERON_CORE/'),
        ...
        CurieNamespace('chembio', 'http://example.org/UNKNOWN/chembio/'),
