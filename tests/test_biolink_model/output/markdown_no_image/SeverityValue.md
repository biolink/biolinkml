...
![img](http://yuml.me/diagram/nofunky;dir:TB/class/[NamedThing]<has%20qualitative%20value(i)%200..1-%20[SeverityValue&#124;id(i):identifier_type;name(i):label_type;category(i):iri_type%20%2B],[QuantityValue]<has%20quantitative%20value(i)%200..*-++[SeverityValue],[OntologyClass]<has%20attribute%20type(i)%200..1-%20[SeverityValue],[Association]-%20severity%20qualifier(i)%200..1>[SeverityValue],[Attribute]^-[SeverityValue],[QuantityValue],[OntologyClass],[NamedThing],[Attribute],[Association])
