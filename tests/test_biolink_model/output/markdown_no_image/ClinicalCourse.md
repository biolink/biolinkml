...
![img](http://yuml.me/diagram/nofunky;dir:TB/class/[QuantityValue],[OntologyClass],[Onset],[NamedThing],[ClinicalCourse&#124;id(i):string;name(i):label_type;category(i):category_type%20%2B]^-[Onset],[Attribute]^-[ClinicalCourse],[Attribute])
