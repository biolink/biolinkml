...
![img](http://yuml.me/diagram/nofunky;dir:TB/class/[SeverityValue],[Publication],[Provider],[OntologyClass],[Onset],[NamedThing],[FrequencyValue],[EntityToPhenotypicFeatureAssociation],[DiseaseToThingAssociation],[Provider]<provided%20by(i)%200..1-%20[DiseaseToPhenotypicFeatureAssociation&#124;relation(i):uriorcurie;id(i):nodeidentifier;negated(i):boolean%20%3F],[Publication]<publications(i)%200..*-%20[DiseaseToPhenotypicFeatureAssociation],[OntologyClass]<qualifiers(i)%200..*-%20[DiseaseToPhenotypicFeatureAssociation],[OntologyClass]<association%20type(i)%200..1-%20[DiseaseToPhenotypicFeatureAssociation],[NamedThing]<object(i)%201..1-%20[DiseaseToPhenotypicFeatureAssociation],[NamedThing]<subject(i)%201..1-%20[DiseaseToPhenotypicFeatureAssociation],[Onset]<onset%20qualifier%200..1-%20[DiseaseToPhenotypicFeatureAssociation],[SeverityValue]<severity%20qualifier%200..1-%20[DiseaseToPhenotypicFeatureAssociation],[FrequencyValue]<frequency%20qualifier%200..1-%20[DiseaseToPhenotypicFeatureAssociation],[BiologicalSex]<sex%20qualifier%200..1-%20[DiseaseToPhenotypicFeatureAssociation],[DiseaseToPhenotypicFeatureAssociation]uses%20-.->[EntityToPhenotypicFeatureAssociation],[DiseaseToPhenotypicFeatureAssociation]uses%20-.->[DiseaseToThingAssociation],[Association]^-[DiseaseToPhenotypicFeatureAssociation],[BiologicalSex],[Association])
