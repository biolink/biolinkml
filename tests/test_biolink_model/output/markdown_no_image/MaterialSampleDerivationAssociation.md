...
![img](http://yuml.me/diagram/nofunky;dir:TB/class/[Publication],[Provider],[OntologyClass],[NamedThing],[Provider]<provided%20by(i)%200..1-%20[MaterialSampleDerivationAssociation&#124;relation:uriorcurie;id(i):nodeidentifier;negated(i):boolean%20%3F],[Publication]<publications(i)%200..*-%20[MaterialSampleDerivationAssociation],[OntologyClass]<qualifiers(i)%200..*-%20[MaterialSampleDerivationAssociation],[OntologyClass]<association%20type(i)%200..1-%20[MaterialSampleDerivationAssociation],[NamedThing]<object%201..1-%20[MaterialSampleDerivationAssociation],[MaterialSample]<subject%201..1-%20[MaterialSampleDerivationAssociation],[Association]^-[MaterialSampleDerivationAssociation],[MaterialSample],[Association])
