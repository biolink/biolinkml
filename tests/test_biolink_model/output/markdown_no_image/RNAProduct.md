...
![img](http://yuml.me/diagram/nofunky;dir:TB/class/[OrganismTaxon],[NoncodingRNAProduct],[GeneProduct],[RNAProductIsoform],[RNAProduct&#124;name(i):symbol_type;has_biological_sequence(i):biological_sequence%20%3F;id(i):identifier_type;category(i):iri_type%20%2B]^-[NoncodingRNAProduct],[RNAProduct]^-[RNAProductIsoform],[GeneProduct]^-[RNAProduct])
