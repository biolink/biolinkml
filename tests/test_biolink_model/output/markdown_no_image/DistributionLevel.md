...
![img](http://yuml.me/diagram/nofunky;dir:TB/class/[NamedThing],[DistributionLevel]<distribution(i)%200..1-%20[DistributionLevel&#124;downloadURL:string%20%3F;title(i):string%20%3F;type(i):string%20%3F;id(i):identifier_type;name(i):label_type;category(i):iri_type%20%2B],[DataSet]<versionOf(i)%200..1-%20[DistributionLevel],[DataFile]<source%20data%20file(i)%200..1-%20[DistributionLevel],[DataSetVersion]-%20distribution%200..1>[DistributionLevel],[DataSetVersion]^-[DistributionLevel],[DataSetVersion],[DataSet],[DataFile])
