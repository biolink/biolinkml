...
![img](http://yuml.me/diagram/nofunky;dir:TB/class/[SequenceVariantModulatesTreatmentAssociation]-%20object%201..1>[Treatment&#124;id(i):identifier_type;name(i):label_type;category(i):iri_type%20%2B],[ExposureEvent]^-[Treatment],[SequenceVariantModulatesTreatmentAssociation],[PhenotypicFeature],[OrganismalEntity],[NamedThing],[ExposureEvent],[DiseaseOrPhenotypicFeature])
