...
![img](http://yuml.me/diagram/nofunky;dir:TB/class/[Transcript],[PhenotypicFeature],[OrganismTaxon],[NamedThing],[MolecularEntity],[GenomicEntity],[OrganismTaxon]<in%20taxon(i)%200..*-%20[GeneProductIsoform&#124;name(i):symbol_type;has_biological_sequence(i):biological_sequence%20%3F;id(i):identifier_type;category(i):iri_type%20%2B],[ProteinIsoform]uses%20-.->[GeneProductIsoform],[RNAProductIsoform]uses%20-.->[GeneProductIsoform],[GeneProduct]^-[GeneProductIsoform],[ProteinIsoform],[GeneProduct],[GeneOrGeneProduct],[DiseaseOrPhenotypicFeature],[AnatomicalEntity],[RNAProductIsoform])
