...
![img](http://yuml.me/diagram/nofunky;dir:TB/class/[NamedThing],[GeographicLocation]^-[GeographicLocationAtTime&#124;timepoint:time_type%20%3F;latitude(i):float%20%3F;longitude(i):float%20%3F;id(i):identifier_type;name(i):label_type;category(i):iri_type%20%2B],[GeographicLocation])
