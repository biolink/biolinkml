...
![img](http://yuml.me/diagram/nofunky;dir:TB/class/[PhenotypicFeature],[OrganismTaxon],[NamedThing],[IndividualOrganism],[CaseToThingAssociation],[OrganismTaxon]<in%20taxon(i)%200..*-%20[Case&#124;id(i):identifier_type;name(i):label_type;category(i):iri_type%20%2B],[CaseToThingAssociation]-%20subject%201..1>[Case],[IndividualOrganism]^-[Case])
