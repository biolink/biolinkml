...
![img](http://yuml.me/diagram/nofunky;dir:TB/class/[Transcript],[PhenotypicFeature],[OrganismTaxon],[NamedThing],[MolecularEntity],[OrganismTaxon]<in%20taxon(i)%200..*-%20[Metabolite&#124;id(i):identifier_type;name(i):label_type;category(i):iri_type%20%2B],[ChemicalSubstance]^-[Metabolite],[GenomicEntity],[DiseaseOrPhenotypicFeature],[ChemicalSubstance])
