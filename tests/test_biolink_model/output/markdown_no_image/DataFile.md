...
![img](http://yuml.me/diagram/nofunky;dir:TB/class/[SourceFile],[NamedThing],[InformationContentEntity],[DataSetVersion],[DataSetVersion]-%20source%20data%20file%200..1>[DataFile&#124;license(i):string%20%3F;rights(i):string%20%3F;format(i):string%20%3F;creation_date(i):date%20%3F;id(i):string;iri(i):iri_type%20%3F;type(i):string%20%3F;name(i):label_type%20%3F;description(i):narrative_text%20%3F;source(i):label_type%20%3F],[DataFile]^-[SourceFile],[InformationContentEntity]^-[DataFile],[Attribute],[Agent])
