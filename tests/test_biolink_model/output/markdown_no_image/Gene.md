...
![img](http://yuml.me/diagram/nofunky;dir:TB/class/[TranscriptToGeneRelationship],[Transcript],[SequenceVariant],[PhenotypicFeature],[OrganismTaxon],[NamedThing],[MolecularEntity],[GenotypeToGeneAssociation],[GenomicEntity],[GeneToGeneProductRelationship],[GeneProduct],[GeneOrGeneProduct],[OrganismTaxon]<in%20taxon(i)%200..*-%20[Gene&#124;name(i):symbol_type;has_biological_sequence(i):biological_sequence%20%3F;id(i):identifier_type;category(i):iri_type%20%2B],[GeneToGeneProductRelationship]-%20subject%201..1>[Gene],[GenotypeToGeneAssociation]-%20object%201..1>[Gene],[NamedThing]-%20has%20gene(i)%200..1>[Gene],[SequenceVariant]-%20has%20gene%200..*>[Gene],[TranscriptToGeneRelationship]-%20object%201..1>[Gene],[GeneOrGeneProduct]^-[Gene],[DiseaseOrPhenotypicFeature],[AnatomicalEntity])
