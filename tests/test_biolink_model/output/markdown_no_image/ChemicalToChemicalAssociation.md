...
![img](http://yuml.me/diagram/nofunky;dir:TB/class/[Publication],[Provider],[OntologyClass],[NamedThing],[ChemicalToThingAssociation],[ChemicalToChemicalDerivationAssociation],[Provider]<provided%20by(i)%200..1-%20[ChemicalToChemicalAssociation&#124;relation(i):uriorcurie;id(i):nodeidentifier;negated(i):boolean%20%3F],[Publication]<publications(i)%200..*-%20[ChemicalToChemicalAssociation],[OntologyClass]<qualifiers(i)%200..*-%20[ChemicalToChemicalAssociation],[OntologyClass]<association%20type(i)%200..1-%20[ChemicalToChemicalAssociation],[NamedThing]<subject(i)%201..1-%20[ChemicalToChemicalAssociation],[ChemicalSubstance]<object%201..1-%20[ChemicalToChemicalAssociation],[ChemicalToChemicalAssociation]uses%20-.->[ChemicalToThingAssociation],[ChemicalToChemicalAssociation]^-[ChemicalToChemicalDerivationAssociation],[Association]^-[ChemicalToChemicalAssociation],[ChemicalSubstance],[Association])
