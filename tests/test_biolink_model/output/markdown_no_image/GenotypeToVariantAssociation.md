...
![img](http://yuml.me/diagram/nofunky;dir:TB/class/[SequenceVariant],[Publication],[Provider],[OntologyClass],[Provider]<provided%20by(i)%200..1-%20[GenotypeToVariantAssociation&#124;relation:uriorcurie;id(i):nodeidentifier;negated(i):boolean%20%3F],[Publication]<publications(i)%200..*-%20[GenotypeToVariantAssociation],[OntologyClass]<qualifiers(i)%200..*-%20[GenotypeToVariantAssociation],[OntologyClass]<association%20type(i)%200..1-%20[GenotypeToVariantAssociation],[SequenceVariant]<object%201..1-%20[GenotypeToVariantAssociation],[Genotype]<subject%201..1-%20[GenotypeToVariantAssociation],[Association]^-[GenotypeToVariantAssociation],[Genotype],[Association])
