...
![img](http://yuml.me/diagram/nofunky;dir:TB/class/[PlanetaryEntity],[Occurrent],[EnvironmentalProcess&#124;id(i):string;name(i):label_type;category(i):iri_type%20%2B]uses%20-.->[Occurrent],[PlanetaryEntity]^-[EnvironmentalProcess])
