...
![img](http://yuml.me/diagram/nofunky;dir:TB/class/[Treatment],[Provider]<provided%20by(i)%200..1-%20[SequenceVariantModulatesTreatmentAssociation&#124;relation(i):uriorcurie;id(i):nodeidentifier;negated(i):boolean%20%3F],[Publication]<publications(i)%200..*-%20[SequenceVariantModulatesTreatmentAssociation],[OntologyClass]<qualifiers(i)%200..*-%20[SequenceVariantModulatesTreatmentAssociation],[OntologyClass]<association%20type(i)%200..1-%20[SequenceVariantModulatesTreatmentAssociation],[Treatment]<object%201..1-%20[SequenceVariantModulatesTreatmentAssociation],[SequenceVariant]<subject%201..1-%20[SequenceVariantModulatesTreatmentAssociation],[Association]^-[SequenceVariantModulatesTreatmentAssociation],[SequenceVariant],[Publication],[Provider],[OntologyClass],[Association])
