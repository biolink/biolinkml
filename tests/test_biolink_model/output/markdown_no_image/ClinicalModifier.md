...
![img](http://yuml.me/diagram/nofunky;dir:TB/class/[QuantityValue],[OntologyClass],[NamedThing],[NamedThing]<has%20qualitative%20value(i)%200..1-%20[ClinicalModifier&#124;id(i):identifier_type;name(i):label_type;category(i):iri_type%20%2B],[QuantityValue]<has%20quantitative%20value(i)%200..*-++[ClinicalModifier],[OntologyClass]<has%20attribute%20type(i)%200..1-%20[ClinicalModifier],[Attribute]^-[ClinicalModifier],[Attribute],[Association])
