...
![img](http://yuml.me/diagram/nofunky;dir:TB/class/[SocioeconomicOutcome&#124;id(i):string;iri(i):iri_type%20%3F;type(i):string%20%3F;name(i):label_type%20%3F;description(i):narrative_text%20%3F;source(i):label_type%20%3F]uses%20-.->[Outcome],[Behavior]^-[SocioeconomicOutcome],[PhysicalEntity],[Outcome],[NamedThing],[Behavior],[Attribute],[Agent])
