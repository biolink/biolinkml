...
![img](http://yuml.me/diagram/nofunky;dir:TB/class/[QuantityValue],[PhenotypicSex],[OntologyClass],[NamedThing],[GenotypicSex],[EntityToPhenotypicFeatureAssociation]-%20sex%20qualifier%200..1>[BiologicalSex&#124;id(i):string;name(i):label_type;category(i):category_type%20%2B],[BiologicalSex]^-[PhenotypicSex],[BiologicalSex]^-[GenotypicSex],[Attribute]^-[BiologicalSex],[EntityToPhenotypicFeatureAssociation],[Attribute],[Association])
