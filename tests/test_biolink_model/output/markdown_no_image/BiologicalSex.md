...
![img](http://yuml.me/diagram/nofunky;dir:TB/class/[QuantityValue],[PhenotypicSex],[OntologyClass],[NamedThing],[GenotypicSex],[NamedThing]<has%20qualitative%20value(i)%200..1-%20[BiologicalSex&#124;id(i):identifier_type;name(i):label_type;category(i):iri_type%20%2B],[QuantityValue]<has%20quantitative%20value(i)%200..*-++[BiologicalSex],[OntologyClass]<has%20attribute%20type(i)%200..1-%20[BiologicalSex],[Association]-%20sex%20qualifier(i)%200..1>[BiologicalSex],[BiologicalSex]^-[PhenotypicSex],[BiologicalSex]^-[GenotypicSex],[Attribute]^-[BiologicalSex],[Attribute],[Association])
