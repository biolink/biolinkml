...
![img](http://yuml.me/diagram/nofunky;dir:TB/class/[ProteinIsoform&#124;name(i):label_type;description(i):narrative_text%20%3F;synonym(i):label_type%20*;xref(i):iri_type%20*;has_biological_sequence(i):biological_sequence%20%3F;id(i):string;category(i):category_type%20%2B]uses%20-.->[GeneProductIsoform],[Protein]^-[ProteinIsoform],[Protein],[OrganismTaxon],[GeneProductIsoform])
