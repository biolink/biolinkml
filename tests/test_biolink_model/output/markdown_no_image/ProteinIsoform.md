...
![img](http://yuml.me/diagram/nofunky;dir:TB/class/[Transcript],[OrganismTaxon]<in%20taxon(i)%200..*-%20[ProteinIsoform&#124;name(i):symbol_type;has_biological_sequence(i):biological_sequence%20%3F;id(i):identifier_type;category(i):iri_type%20%2B],[ProteinIsoform]uses%20-.->[GeneProductIsoform],[Protein]^-[ProteinIsoform],[Protein],[PhenotypicFeature],[OrganismTaxon],[NamedThing],[MolecularEntity],[GenomicEntity],[GeneProductIsoform],[GeneOrGeneProduct],[DiseaseOrPhenotypicFeature],[AnatomicalEntity])
