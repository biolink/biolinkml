...
![img](http://yuml.me/diagram/nofunky;dir:TB/class/[VariantToThingAssociation],[Provider]<provided%20by(i)%200..1-%20[VariantToPhenotypicFeatureAssociation&#124;relation(i):uriorcurie;id(i):nodeidentifier;negated(i):boolean%20%3F],[Publication]<publications(i)%200..*-%20[VariantToPhenotypicFeatureAssociation],[OntologyClass]<qualifiers(i)%200..*-%20[VariantToPhenotypicFeatureAssociation],[OntologyClass]<association%20type(i)%200..1-%20[VariantToPhenotypicFeatureAssociation],[NamedThing]<object(i)%201..1-%20[VariantToPhenotypicFeatureAssociation],[Onset]<onset%20qualifier%200..1-%20[VariantToPhenotypicFeatureAssociation],[SeverityValue]<severity%20qualifier%200..1-%20[VariantToPhenotypicFeatureAssociation],[FrequencyValue]<frequency%20qualifier%200..1-%20[VariantToPhenotypicFeatureAssociation],[BiologicalSex]<sex%20qualifier%200..1-%20[VariantToPhenotypicFeatureAssociation],[SequenceVariant]<subject%201..1-%20[VariantToPhenotypicFeatureAssociation],[VariantToPhenotypicFeatureAssociation]uses%20-.->[VariantToThingAssociation],[VariantToPhenotypicFeatureAssociation]uses%20-.->[EntityToPhenotypicFeatureAssociation],[Association]^-[VariantToPhenotypicFeatureAssociation],[SeverityValue],[SequenceVariant],[Publication],[Provider],[OntologyClass],[Onset],[NamedThing],[FrequencyValue],[EntityToPhenotypicFeatureAssociation],[BiologicalSex],[Association])
