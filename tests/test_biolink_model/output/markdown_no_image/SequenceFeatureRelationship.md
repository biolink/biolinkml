...
![img](http://yuml.me/diagram/nofunky;dir:TB/class/[TranscriptToGeneRelationship],[GenomicEntity]<object%201..1-%20[SequenceFeatureRelationship&#124;relation(i):uriorcurie;id(i):nodeidentifier;negated(i):boolean%20%3F],[GenomicEntity]<subject%201..1-%20[SequenceFeatureRelationship],[SequenceFeatureRelationship]^-[TranscriptToGeneRelationship],[SequenceFeatureRelationship]^-[GeneToGeneProductRelationship],[SequenceFeatureRelationship]^-[ExonToTranscriptRelationship],[Association]^-[SequenceFeatureRelationship],[Publication],[Provider],[OntologyClass],[GenomicEntity],[GeneToGeneProductRelationship],[ExonToTranscriptRelationship],[Association])
