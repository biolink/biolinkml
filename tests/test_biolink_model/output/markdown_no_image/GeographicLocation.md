...
![img](http://yuml.me/diagram/nofunky;dir:TB/class/[PlanetaryEntity],[NamedThing],[GeographicLocationAtTime],[GeographicLocation&#124;latitude:float%20%3F;longitude:float%20%3F;id(i):identifier_type;name(i):label_type;category(i):iri_type%20%2B]^-[GeographicLocationAtTime],[PlanetaryEntity]^-[GeographicLocation])
